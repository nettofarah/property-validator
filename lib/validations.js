...
validations.presence = function presence(paramName) {
  return function(params) {
    ...
    return {
      field: paramName,
      message: message(paramName, "required"),
...
validations.email = validations.isEmail = function email(paramName) {
  return checkParam(
    paramName,
    message(paramName, 'should look like an email address'),
    validator.isEmail
  );
}
...
validations.isAlpha = function isAlpha(paramName) {
  return checkParam(
    paramName,
    message(paramName, 'should contain only letters'),
    validator.isAlpha
  );
}
...
validations.equals = validations.isEqual = function equals(paramName, comparison) {
  return checkParam(
    paramName,
    message(paramName, 'should be equal ' + comparison),
    validator.equals,
    comparison
  );
}
...
validations.isAlphanumeric = function isAlphanumeric(paramName) {
  return checkParam(
    paramName,
    message(paramName, 'should be alphanumeric'),
...
validations.isCreditCard = function isCreditCard(paramName) {
  return checkParam(
    paramName,
    message(paramName, 'should look like a credit card'),
...
validations.isCurrency = function isCurrency(paramName, options) {
  return checkParam(
    paramName,
    message(paramName, 'should look like currency'),
    validator.isCurrency, options
  );
}
...
validations.matches = validations.format = function matches(paramName, pattern) {
  return checkParam(
    paramName,
    message(paramName, 'should match ' + pattern.toString()),
...
validations.isUUID = validations.uuid = function isUUID(paramName, version) {
  return checkParam(
    paramName,
    message(paramName, 'should be an UUID'),
...
validations.isDate = function isDate(paramName) {
  return checkParam(
    paramName,
    message(paramName, 'should be a date'),
    validator.isDate
  );
}
...
validations.isDecimal = function isDecimal(paramName) {
  return checkParam(
    paramName,
    message(paramName, 'should be a decimal number'),
    validator.isDecimal
  );
}

validations.isIn = validations.oneOf = function isIn(paramName, values) {
  return checkParam(
    paramName,
    message(paramName, 'should be one of [' + values.join(', ') + ']'),
    validator.isIn,
    values
  );
}
...
validations.isJSON = function isJSON(paramName) {
  return checkParam(
    paramName,
    message(paramName, 'should be a JSON'),
    validator.isJSON
  );
}
...
validations.isNull = function isNull(paramName) {
  return checkParam(
    paramName,
    message(paramName, 'should be null'),
    validator.isNull
  );
}
...
validations.isNumeric = function isNumeric(paramName) {
  return checkParam(
    paramName,
    message(paramName, 'should be a number'),
    validator.isNumeric
  );
}
...
validations.isURL = function isURL(paramName, options) {
  return checkParam(
    paramName,
    message(paramName, 'should be an URL'),
