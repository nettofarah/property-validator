...
describe('Validation', function() {
  ...
  describe('presence validation', function() {
    ...
    it('fails when fields are null or undefined', function() {
      ...
      var validation = validate(params, [presence('foo'), presence('bar')])
  ...
  describe('optional validation', function() {
    ...
    it('does not interfere with good validations', function() {
      ...
      var validation = validate(params, [optional(email('email_address'))])
  ...
  describe('Custom validation messages', function() {
    ...
    it('works with multi param helpers', function() {
      ...
      var validation = validate(params, [
        ...
        isCurrency(
          'brl',
          { symbol: 'R$', require_symbol: true },
          'Reais are required to be prefixed with R$'
        ),
...
describe('Validation Helpers', function() {
  ...
  it('emails', function() {
    ...
    m(v.isEmail('i', 'bad email')({}), 'bad email')
  })
  ...
  it('oneOf', function() {
    t(
      v.oneOf('fruit', ['banana', 'apple', 'orange'])({
        fruit: 'banana'
      })
    )
  ...
  it('isLength', function() {
    ...
    m(
      v.isLength('i', { min: 10 })({ i: 'something' }),
      '"i" length should be equals or greater then 10'
    )
    m(
      v.isLength('i', { max: 5 })({ i: 'something' }),
      '"i" length should be equals or less then 5'
    )
    m(
      v.isLength('i', { min: 10, max: 5 })({ i: 'something' }),
      '"i" length should be equals or greater then 10 and equals or less then 5'
    )
  })
})
